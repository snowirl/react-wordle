...
const Header = () => {
  ...
  return (
    <div className="flex justify-around  p-3 md:p-3.5 border-b-[1px] border-t-0 border-x-0 border-b-black/20 dark:border-b-white/20 border w-full">
      ...
      <div className="flex-grow w-full  flex justify-end">
        <button
          onClick={() => changeTheme()}
          className="hover:bg-gray-200 dark:hover:bg-zinc-800 rounded-md p-2.5 flex items-center cursor-pointer justify-center"
        >
          {theme === "light" ? (
            <svg
